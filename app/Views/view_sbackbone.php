        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="d-sm-flex align-items-center justify-content-center mb-4">
                    <h1 class="h3 mb-0 text-gray-800"><span>POP S-BACKBONE</span></h1>
                ...
                <div class="card" style="height:181px;">
                    ...
                    <div class="card-body">
                        <div class=" row">
                            <div class="col-1">
                                <a class="nav-link collapsed" href="<?= site_url('sbackbonespm') ?>"
                            ...
                            <div class="col-1">
                                <a class="nav-link collapsed" href="<?= site_url('sbackbonebpm') ?>"
                                    data-toggle="collapse" data-target="#collapseTwo" aria-expanded="true"
                                    aria-controls="collapseTwo">
                                    <button class="ellipse hijau ">
